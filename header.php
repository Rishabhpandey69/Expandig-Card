<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Prime Rose</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active me-2" href="index.php">Rooms</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-2" href="facilities.php">Facility</a>
        </li>
        <li class="nav-item">
          <a class="nav-link me-2" href="#">Contacts Us</a>
        </li>
        <li class="nav-item">
      ...
      <form>
        ...
        <div class="modal-body">
          <span class="badge bg-light text-dark mb-3 text wrap lh-base">
            Note:Your detail must match with your ID(Aadhaar card,driving license,etc)that will be required during
            check-in.
          </span>
